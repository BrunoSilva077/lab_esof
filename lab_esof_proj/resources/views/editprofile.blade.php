        ...
        <div class="grid-item item3 menuedit">
            <div class="sidemenuedit">
                <div class="profileinputline active">
                    <h3>Account<i class="fa-solid fa-box" style="opacity:1.0;"></i></h3>
                </div>
                <div class="profileinputline">
                    <h3>Favorites<i class="fa-solid fa-heart"></i></h3>
                </div>
                <div class="profileinputline">
                    <h3>History<i class="fa-solid fa-clock-rotate-left"></i></h3>
                </div>
            </div>
        </div>
