...
@section('content')
<div class="adordermenu">
    <div class="grid-container">
        <div class="grid-item item2 adorder">
            <div class="sidemenu">
        ...
        <div class="grid-item item1 adorder"></div>
        <div class="grid-item item9 adorder">
            <div class="upmainmenu">
                <div class="checkoutinputline">
